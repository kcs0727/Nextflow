...
} from "../../../../../chunk-37TSS3UR.mjs";
import "../../../../../chunk-EXP2OSCK.mjs";
import "../../../../../chunk-XVEK4UI4.mjs";
...
var ownKeys = /* @__PURE__ */ __name((o2) => Object.keys(o2).concat(Object.getOwnPropertySymbols(o2)), "ownKeys");
...
var createTransformationGuard = /* @__PURE__ */ __name((tag) => (ast) => ast._tag === tag, "createTransformationGuard");
...
var map4 = /* @__PURE__ */ dual(2, (self, f) => reduce2(self, empty6(), (map13, value, key) => set(map13, key, f(value, key))));
...
var fromIterable4 = /* @__PURE__ */ __name((elements) => {
  const set5 = beginMutation2(empty7());
...
var union2 = /* @__PURE__ */ dual(2, (self, that) => mutate(empty7(), (set5) => {
...
var failures = /* @__PURE__ */ __name((self) => reverse2(reduce7(self, empty5(), (list, cause) => cause._tag === OP_FAIL ? some2(pipe(list, prepend2(cause.error))) : none2())), "failures");
var defects = /* @__PURE__ */ __name((self) => reverse2(reduce7(self, empty5(), (list, cause) => cause._tag === OP_DIE ? some2(pipe(list, prepend2(cause.defect))) : none2())), "defects");
var interruptors = /* @__PURE__ */ __name((self) => reduce7(self, empty8(), (set5, cause) => cause._tag === OP_INTERRUPT ? some2(pipe(set5, add4(cause.fiberId))) : none2()), "interruptors");
...
var stripFailures = /* @__PURE__ */ __name((self) => match5(self, {
  onEmpty: empty15,
  onFail: /* @__PURE__ */ __name(() => empty15, "onFail"),
  onDie: die,
...
var currentInterruptedCause = /* @__PURE__ */ globalValue(/* @__PURE__ */ Symbol.for("effect/FiberRef/currentInterruptedCause"), () => fiberRefUnsafeMake(empty15, {
  fork: /* @__PURE__ */ __name(() => empty15, "fork"),
  join: /* @__PURE__ */ __name((parent, _) => parent, "join")
}));
...
var fromFlat = /* @__PURE__ */ __name((flat) => make20({
  load: /* @__PURE__ */ __name((config3) => flatMap6(fromFlatLoop(flat, empty2(), config3, false), (chunk2) => match2(head(chunk2), {
    onNone: /* @__PURE__ */ __name(() => fail2(MissingData(empty2(), `Expected a single value having structure: ${config3}`)), "onNone"),
    onSome: succeed
  })), "load"),
  flattened: flat
}), "fromFlat");
...
// node_modules/effect/dist/esm/internal/defaultServices.js
var liveServices = /* @__PURE__ */ pipe(/* @__PURE__ */ empty4(), /* @__PURE__ */ add2(clockTag, /* @__PURE__ */ make18()), /* @__PURE__ */ add2(consoleTag, defaultConsole), /* @__PURE__ */ add2(randomTag, /* @__PURE__ */ make21(/* @__PURE__ */ Math.random())), /* @__PURE__ */ add2(configProviderTag, /* @__PURE__ */ fromEnv()), /* @__PURE__ */ add2(tracerTag, nativeTracer));
...
var diff7 = /* @__PURE__ */ __name((oldValue, newValue) => {
  ...
  const added = pipe(newSupervisors, difference3(oldSupervisors), reduce4(empty23, (patch9, supervisor) => combine7(patch9, {
    _tag: OP_ADD_SUPERVISOR,
    supervisor
  })));
  const removed = pipe(oldSupervisors, difference3(newSupervisors), reduce4(empty23, (patch9, supervisor) => combine7(patch9, {
...
var fromAST = /* @__PURE__ */ __name((ast, options) => {
  ...
  return go2(ast, options.definitions, handleIdentifier, [], {
    getRef,
    target,
...
var getJsonSchemaAnnotations = /* @__PURE__ */ __name((ast, annotated) => {
  ...
  if (isSome2(oexamples) && oexamples.value.length > 0) {
    ...
    const examples = filterMap2(oexamples.value, (e) => getOption4(e));
...
var isOverrideAnnotation = /* @__PURE__ */ __name((jsonSchema) => {
...
var mergeRefinements = /* @__PURE__ */ __name((from, jsonSchema, annotations2) => {
  const out = {
    ...from,
    ...annotations2,
    ...jsonSchema
...
var isNeverJSONSchema = /* @__PURE__ */ __name((jsonSchema) => "$id" in jsonSchema && jsonSchema.$id === "/schemas/never", "isNeverJSONSchema");
var isAnyJSONSchema = /* @__PURE__ */ __name((jsonSchema) => "$id" in jsonSchema && jsonSchema.$id === "/schemas/any", "isAnyJSONSchema");
var isUnknownJSONSchema = /* @__PURE__ */ __name((jsonSchema) => "$id" in jsonSchema && jsonSchema.$id === "/schemas/unknown", "isUnknownJSONSchema");
var isVoidJSONSchema = /* @__PURE__ */ __name((jsonSchema) => "$id" in jsonSchema && jsonSchema.$id === "/schemas/void", "isVoidJSONSchema");
...
var go2 = /* @__PURE__ */ __name((ast, $defs, handleIdentifier, path, options) => {
  if (handleIdentifier) {
    const identifier2 = getJSONIdentifier(ast);
    if (isSome2(identifier2)) {
      const id = identifier2.value;
      ...
      if (!has($defs, id)) {
        $defs[id] = out;
        $defs[id] = go2(ast, $defs, false, path, options);
      }
      return out;
    }
  }
  ...
  if (isSome2(hook)) {
    ...
    if (isRefinement(ast)) {
      ...
      if (t === void 0) {
        return mergeRefinements(go2(ast.from, $defs, handleIdentifier, path, options), handler, getJsonSchemaAnnotations(ast));
      } else if (!isOverrideAnnotation(handler)) {
        return go2(t, $defs, handleIdentifier, path, options);
      }
    }
  ...
  const surrogate = getSurrogateAnnotation(ast);
  if (isSome2(surrogate)) {
    return go2(surrogate.value, $defs, handleIdentifier, path, options);
  }
  switch (ast._tag) {
    case "Declaration":
    ...
    case "TupleType": {
      const elements = ast.elements.map((e, i) => ({
        ...go2(e.type, $defs, true, path.concat(i), options),
        ...getJsonSchemaAnnotations(e.type, e)
      }));
      const rest = ast.rest.map((annotatedAST) => ({
        ...go2(annotatedAST.type, $defs, true, path, options),
    ...
    case "TypeLiteral": {
      ...
      for (const is of ast.indexSignatures) {
        ...
        switch (parameter._tag) {
          case "StringKeyword": {
            output.additionalProperties = go2(pruned, $defs, true, path, options);
            break;
          }
          case "TemplateLiteral": {
            patternProperties = go2(pruned, $defs, true, path, options);
            propertyNames = {
              type: "string",
          ...
          case "Refinement": {
            patternProperties = go2(pruned, $defs, true, path, options);
            propertyNames = go2(parameter, $defs, true, path, options);
            break;
          }
          case "SymbolKeyword": {
            const indexSignaturePath = path.concat("[symbol]");
            output.additionalProperties = go2(pruned, $defs, true, indexSignaturePath, options);
            propertyNames = go2(parameter, $defs, true, indexSignaturePath, options);
            break;
          }
        }
      }
      for (let i = 0; i < ast.propertySignatures.length; i++) {
        ...
        if (isString(name)) {
          ...
          output.properties[name] = {
            ...go2(type, $defs, true, path.concat(ps.name), options),
    ...
    case "Union": {
      const members = [];
      for (const type of ast.types) {
        const jsonSchema = go2(type, $defs, true, path, options);
        if (!isNeverJSONSchema(jsonSchema)) {
          const last3 = members[members.length - 1];
          if (isMergeableEnum(jsonSchema) && last3 !== void 0 && isMergeableEnum(last3)) {
            members[members.length - 1] = {
              enum: last3.enum.concat(jsonSchema.enum)
            };
          } else {
    ...
    case "Refinement": {
      ...
      return go2(ast.from, $defs, handleIdentifier, path, options);
    }
    case "TemplateLiteral": {
      const regex = getTemplateLiteralRegExp(ast);
      return {
    ...
    case "Suspend": {
      ...
      return go2(ast.f(), $defs, handleIdentifier, path, options);
    }
    case "Transformation": {
      if (isParseJsonTransformation(ast.from)) {
        ...
        if (isContentSchemaSupported(options)) {
          out["contentSchema"] = go2(ast.to, $defs, handleIdentifier, path, options);
        }
        return out;
      }
      let next = ast.from;
      ...
      return go2(next, $defs, handleIdentifier, path, options);
    }
  }
}, "go");
